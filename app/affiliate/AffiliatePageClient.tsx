...
export default function AffiliatePageClient({ affiliatePackages }: AffiliatePageClientProps) {
    ...
    try {
      const response = await fetch("/api/inquiries", {
        ...
        body: JSON.stringify({
          ...
          email: formData.email,
          phone: formData.phone,
          estate: "Affiliate Application",
          message: `Experience: ${formData.experience}. Promotion Channels: ${formData.channels}`,
        }),
      });
